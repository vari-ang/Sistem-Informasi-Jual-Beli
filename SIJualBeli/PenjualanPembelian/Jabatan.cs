...
namespace PenjualanPembelian
{
    public class Jabatan
    {
        ...
        {
            string sql = "INSERT INTO jabatan (IdJabatan, Nama) VALUES ('" + j.IdJabatan + "', '" + j.NamaJabatan.Replace("'", "\\'") + "')";
        ...
        {
            string sql = "UPDATE jabatan SET Nama = '" + j.NamaJabatan.Replace("'", "\\'") + "' WHERE IdJabatan = '" + j.IdJabatan + "'";
